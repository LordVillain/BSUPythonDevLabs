...
**Ключевые выводы:**
Большинство клиентов — молодые люди до 40 лет, берущие небольшие кредиты. Рискованная группа составляет треть выборки, что является значимым показателем для банковского скоринга.
