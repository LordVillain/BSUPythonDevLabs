...
# 1. Анализ набора данных "German Credit Data"
...
*Интерпретация:* Основная масса заемщиков находится в диапазоне 25–35 лет. После 40 лет кредитная активность резко снижается.
...
1.  **Выборка: Топ-3 самых молодых надежных заемщиков**
    *   *Цель:* Определить профиль самых молодых клиентов, которые классифицированы как "Good".
    *   *Результат:* Самыми молодыми надежными заемщиками являются клиенты 19–20 лет. Интересно, что, несмотря на возраст, они берут кредиты на конкретные материальные цели (мебель/техника), а суммы варьируются от небольших до средних.

2.  **Агрегация: Рейтинг целей по средней сумме кредита**
    *   *Цель:* Выяснить, на какие цели банк выдает самые крупные суммы.
    *   *Результат:*
        1.  **Others (Прочее):** Самый высокий средний чек (более 8000 DM).
        2.  **Car (used):** Покупка подержанных авто (более 5300 DM).
        3.  **Business:** Кредиты на бизнес.
        *Вывод:* Кредиты на "неопределенные" цели являются самыми дорогостоящими.

3.  **Группировка: Сравнительный портрет заемщика (Good vs Bad)**
    *   *Цель:* Сравнить средние показатели возраста, суммы и срока кредита для двух классов риска.
    *   *Результат:*
        *   **Good:** Средний возраст — 36.2 года, сумма — ~2985 DM, срок — 19 мес.
        *   **Bad:** Средний возраст — 33.9 года, сумма — ~3938 DM, срок — 24.9 мес.
        *Вывод:* Рискованные заемщики в среднем моложе, просят сумму на 30% больше и на более длительный срок.

4.  **Анализ рисков: Влияние типа жилья (Crosstab)**
    *   *Цель:* Посмотреть распределение рисков в зависимости от жилищных условий (`own`, `rent`, `for free`).
    *   *Результат:* Абсолютное большинство клиентов — собственники жилья (`own`). Однако в категории "бесплатное проживание" (`for free`) наблюдается непропорционально высокая доля "плохих" кредитов по сравнению с собственниками.

5.  **Сложный фильтр: Поиск аномалий**
    *   *Цель:* Найти клиентов с "Критическим счетом" (плохой историей), которым всё равно одобрили крупные кредиты (>5000 DM).
    *   *Результат:* Найдена группа клиентов с такими параметрами. Анализ показал, что банк, вероятно, пошел на риск из-за их статуса работы (часто это квалифицированные специалисты или менеджеры), несмотря на проблемы с выплатами в прошлом.
