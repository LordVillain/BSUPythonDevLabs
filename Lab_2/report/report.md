...
- Освоил базовые конструкции Python: условия и циклы.
- Научился проектировать функции, разбивать программу на модули и пакеты.
- Применил коллекции Python (списки, словари) для хранения и обработки данных.
- Освоил обработку ошибок и исключений, проектирование собственных исключений.
- Научился работать с файлами: чтение/запись и форматом CSV.
- Освоил принцип написания тестов с помощью pytest